...
const SpecificProduct = ({
    ...
    const fetchData = async () => {
      try {
        ...
        const { data } = await axios.get(
          `https://castemerenfts-backend.onrender.com/products?_id=${productId}`
        );
  ...
  const agregarFav = async () => {
    ...
    try {
      await axios.post(
        "https://castemerenfts-backend.onrender.com/products/favorite",
        data
      );
  ...
  const agregarCart = async () => {
    ...
    try {
      await axios.post(
        "https://castemerenfts-backend.onrender.com/products/cart",
        data
      );
          ...
          <>
            ...
            <div className="col-11 col-md-4 col-lg-5 col-xl-4">
              ...
              <div className="d-flex">
                ...
                <button
                  onClick={agregarFav}
                  className={`btn btn-warning ${addedToFav ? "disabled" : ""}`}
                >
                  Agregar a favoritos
                </button>
              </div>
